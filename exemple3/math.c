...
options[] = {	{"double",'d', 0, NULL,"uliser une valeur double"},
		...
		{"acos",'a',0,"X","cosinus(-1) d'un nombre X"},
		{"asin",'A',0,"X","sinus(-1) d'un nombre X"},
		{"atan",'T',0,"X","tangente(-1) d'un nombre X"},
		...
		{"pow",'p',0, "X:Y","puissance d'une valeur X élevé à la valeur Y"},
		{"fmod",'m',0, "X:Y","reste de X/Y"},
		...
		{"radian",'r',0,NULL,"les entrées sont en radian plutôt quand degrès"},
		{"odegres",'x',0,NULL,"la sortie en degrès"},
...
struct parser argp = { options, parse_opt, "OPTION", NULL, doc, &program, NULL };
void
